export const projects = [
  ...
  },
  {
    ...
    아직 미흡한 점이 많아, 추후에 실제 저의 블로그로 사용할 수 있도록 코드 리팩토링 및 기능 추가를 하겠습니다.<br><br>
  ...
  },
  {
    ...
    teamSize: '1명',
    contribution: '100%',
    description: `인턴으로서 참여한 첫 프로젝트입니다. (대표 이미지는 보안을 위해 블러처리하였습니다.) 프로젝트의 목표는 디자이너와 개발자 간의 협업을 지원하는 Figma에서, 특정 컴포넌트를 지도상의 특정 위치에 배치하고, 해당 위치의 위경도 좌표를 기억할 수 있는 Figma 플러그인을 개발하는 것이었습니다.<br><br>
