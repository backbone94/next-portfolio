export const projects = [
  ...
  },
  {
    ...
    description: `본격적으로 웹 개발자가 되기로 마음 먹기 전에 진행한 프로젝트입니다. 웹 개발과는 무관하지만 복잡했던 회로 조립, 학교에서 배우지 않았던 아두이노 시스템 프로그래밍은 개인적으로 값진 경험이었습니다.<br><br>Android Studio를 통해 RC카와 블루투스 통신이 가능한 심플한 App을 개발하였습니다. App을 통해 RC카를 직접 수동 조종할 수도 있고, RC카의 앞 부분에 달린 초음파 센서를 통해 RC카 스스로 운전해 나가는 자율 주행 기능도 추가하였습니다.`,
  },
  {
    title: '살롱 | SSALON',
    media: [
    ...
    description: `아주대학교 소프트웨어학과 졸업 작품입니다. 저는 프론트엔드 개발자를 목표로 삼고 있었지만, 웹 개발자로서의 시야를 넓히기 위해 이 프로젝트에서는 백엔드 개발을 맡았습니다.<br><br>Spring에 익숙하지 않은 상태에서 대규모 프로젝트를 진행하는 것은 도전적인 경험이었지만, 이를 통해 CI/CD의 구축과 AWS EC2 인스턴스의 운영에 대해 깊이 있게 학습할 수 있었습니다. JWT와 OAuth 2.0을 활용한 (카카오, 구글, 네이버) 소셜 로그인 기능 구현을 통해 보안과 인증 처리에 대한 경험을 쌓았으며, WebSocket을 이용한 실시간 채팅 기능 개발을 통해 웹 애플리케이션의 실시간 처리 능력을 향상시켰습니다.`,
  },
  {
    ...
    description: `인턴으로서 참여한 첫 프로젝트입니다. 프로젝트의 목표는 디자이너와 개발자 간의 협업을 지원하는 Figma에서 특정 컴포넌트를 지도상의 특정 위치에 배치하고, 해당 좌표를 기억할 수 있는 프로그램을 개발하는 것이었습니다.<br><br>Figma Plugin API를 사용하여 플러그인의 기본 기능들을 구성하였으며, Figma와 (Webpack + TypeScript + React) 간의 원활한 조화를 위해 이미 번들링 설정이 되어 있는 보일러플레이트를 사용하였습니다. 또한, 지도를 표시하기 위해 OpenLayers 라이브러리를 사용하였고, Nominatim 라이브러리를 통해 지도 검색 기능을 구현하였으며, MUI 라이브러리를 활용해 UI를 개선했습니다.`,
  },
  {
