...
export const projects: Project[] = [
  {
    ...
    SSL 인증서는 <strong>Let's Encrypt 인증 기관</strong>을 통해 발급받은 뒤 만료 전에 스스로 갱신되도록 스크립트를 만들어 두었습니다. SSL 인증서 발급 과정은 작업의 순서가 중요하였습니다. 인증서를 미리 준비해 두지 않고 도메인부터 넘기면 그 사이 방문자는 HTTPS에 대한 보안 경고 화면을 보게 됩니다. DB/파일 이관, 그리고 SSL 인증서 작업에서 <strong>되돌리기 어려운 일일수록 먼저 확인하고 진행해야 한다는 점을 배웠습니다.</strong>`,
  },
  {
